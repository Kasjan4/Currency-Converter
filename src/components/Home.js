...
const Home = () => {
      ...
      .then((resp) => {
        ...
        axios.get('https://restcountries.eu/rest/v2/all')
          .then((resp) => {
            ...
            let currenciesWithFlags = currencies.map(obj => {

              let flagFound = countries.find(country => country.currencies[0].code === obj.iso)
  ...
  function handlePair(iso, fromTo) {
    const currency = currencies.find(curr => curr.iso === iso)
        ...
        <Fade>
          <Form>
            ...
            <Form.Group controlId="formBasicNumber">
              ...
              <Form.Control type="number" value={amount} size="lg" onChange={(e) => setAmount(e.target.value)} />
            </Form.Group>
